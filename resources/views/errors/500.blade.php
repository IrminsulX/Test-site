...
<head>
    ...
    <title>Irminsul Studio | 500 - Server Error</title>
...
<body>
    ...
    <div style="display: flex; justify-content: center; align-items: center; min-height: 60vh; padding: 60px 20px;">
        <div style="background: #272930; border-radius: 12px; padding: 60px 80px; text-align: center; max-width: 500px; width: 100%;">
            <h1 style="font-size: 6rem; font-weight: bold; color: #db4f56; margin-bottom: 0; line-height: 1;">500</h1>
            <h3 style="color: #aaa; margin-bottom: 30px;">Server Error</h3>
            <p style="color: #888; margin-bottom: 30px;">Something went wrong on our end. Please try again later.</p>
