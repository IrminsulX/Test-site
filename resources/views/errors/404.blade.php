...
<head>
    ...
    <title>Irminsul Studio | 404 - Page Not Found</title>
...
<body>
    ...
    <div style="display: flex; justify-content: center; align-items: center; min-height: 60vh; padding: 60px 20px;">
        <div style="background: #272930; border-radius: 12px; padding: 60px 80px; text-align: center; max-width: 500px; width: 100%;">
            <h1 style="font-size: 6rem; font-weight: bold; color: #db4f56; margin-bottom: 0; line-height: 1;">404</h1>
            <h3 style="color: #aaa; margin-bottom: 30px;">Page Not Found</h3>
            <p style="color: #888; margin-bottom: 30px;">The page you're looking for doesn't exist or has been moved.</p>
            <a href="{{ route('home') }}" class="btn btn-danger" style="padding: 12px 30px;"><i class="fas fa-home"></i> Back to Home</a>
        </div>
    </div>
