...
<head>
    ...
    <title>Irminsul Studio | Edit Team Member</title>
...
<body>
    ...
    <div class="admin-section">
        ...
        <div class="admin-card">
            <form action="{{ route('admin.team.update', $teamMember->id) }}" method="POST" enctype="multipart/form-data" class="admin-upload-form">
                @csrf
                @method('PUT')
                ...
                <div class="admin-form-row">
                    <div class="admin-form-group">
                        ...
                        <input type="text" name="role" id="role" value="{{ old('role', $teamMember->role) }}" required>
                    </div>
                </div>
                ...
                <div class="admin-form-row">
                    <div class="admin-form-group">
                        ...
                        <textarea name="bio" id="bio" rows="4">{{ old('bio', $teamMember->bio) }}</textarea>
                    </div>
                </div>
                ...
                @if($teamMember->image)
                    <div class="admin-form-row">
                        <div class="admin-form-group">
                            ...
                            <div class="mb-2">
                                <img src="{{ asset('storage/' . $teamMember->image) }}" alt="{{ $teamMember->name }}" style="max-width: 150px;" class="img-thumbnail">
                                <p class="mt-1 text-muted">{{ $teamMember->image }}</p>
                            </div>
                ...
                <div class="admin-form-row">
                    <div class="admin-form-group">
                        ...
                        <input type="text" name="instagram" id="instagram" value="{{ old('instagram', $teamMember->instagram) }}" placeholder="https://instagram.com/...">
                    </div>
                </div>
                ...
                <div class="admin-form-row">
                    <div class="admin-form-group">
                        ...
                        <input type="text" name="twitter" id="twitter" value="{{ old('twitter', $teamMember->twitter) }}" placeholder="https://x.com/...">
                    </div>
                </div>
                ...
                <div class="admin-form-row">
                    <div class="admin-form-group">
                        ...
                        <input type="text" name="discord" id="discord" value="{{ old('discord', $teamMember->discord) }}" placeholder="username">
                    </div>
                </div>
                ...
                <div class="admin-form-row">
                    <div class="admin-form-group">
                        ...
                        <input type="text" name="bluesky" id="bluesky" value="{{ old('bluesky', $teamMember->bluesky) }}" placeholder="https://bsky.app/...">
                    </div>
                </div>
                ...
                <div class="admin-form-row">
                    <div class="admin-form-group">
                        ...
                        <input type="number" name="sort_order" id="sort_order" value="{{ old('sort_order', $teamMember->sort_order) }}">
                    </div>
                </div>

                <button type="submit" class="admin-upload-btn"><i class="fas fa-save"></i> Update Member</button>
            </form>
        </div>
