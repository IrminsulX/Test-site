...
<head>
    ...
    <title>Irminsul Studio | Edit Post</title>
...
<body>
    ...
    <div class="admin-section">
        ...
        <div class="admin-card">
            <form action="{{ route('admin.posts.update', $post->id) }}" method="POST" enctype="multipart/form-data" class="admin-upload-form">
                @csrf
                @method('PUT')
                ...
                @if($post->featured_image)
                    <div class="admin-form-row">
                        <div class="admin-form-group">
                            ...
                            <div class="mb-2">
                                <img src="{{ asset('storage/' . $post->featured_image) }}" alt="Featured" style="max-width: 200px;" class="img-thumbnail">
                                <p class="mt-1 text-muted">{{ $post->featured_image }}</p>
                            </div>
        ...
        <a href="{{ route('admin.posts.index') }}">
            <button class="admin-btn admin-btn-edit mt-3"><i class="fas fa-arrow-left"></i> Back to Posts</button>
        </a>
    </div>
