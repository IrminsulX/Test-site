...
<head>
    ...
    <title>Irminsul Studio | Edit Profile</title>
    ...
    <style>
        ...
        .profile-edit-form-group input[type="file"]::file-selector-button {
            background: #212121;
    ...
    <div class="profile-edit-section">
        <div class="profile-edit-card">
            <div class="profile-edit-heading">
                <span class="profile-edit-star">&#9733;</span>
                <h2>EDIT PROFILE</h2>
                <span class="profile-edit-star">&#9733;</span>
            </div>

            @if(session('success'))
                <div class="profile-edit-success">{{ session('success') }}</div>
            @endif
            ...
            <form method="POST" action="{{ route('profile.update') }}" enctype="multipart/form-data">
                ...
                <div class="profile-edit-form-group">
                    ...
                    <input id="twitter" type="text" name="twitter" value="{{ old('twitter', $user->twitter) }}" placeholder="@username">
                    @error('twitter')
                        <span style="color: #f08a92; font-size: 0.8rem; margin-top: 6px; display: block;">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="profile-edit-form-group">
                    ...
                    <input id="discord" type="text" name="discord" value="{{ old('discord', $user->discord) }}" placeholder="username#0000">
                    @error('discord')
                        <span style="color: #f08a92; font-size: 0.8rem; margin-top: 6px; display: block;">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <button type="submit" class="profile-edit-submit">Save Changes</button>
            </form>

            <a href="{{ route('profile.show', $user) }}" class="profile-edit-back">&#8592; Back to Profile</a>
        </div>
    </div>
